...
echo "     curl -fsSL https://github.com/senet/kctl-env/archive/refs/tags/v$new_version.tar.gz | sha256sum | awk '{print \$1 \"  kctl-env-v$new_version.tar.gz\"}' > kctl-env-v$new_version.tar.gz.sha256"
